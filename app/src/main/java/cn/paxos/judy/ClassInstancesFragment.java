...
public class ClassInstancesFragment extends Fragment {
    ...
    public void setViewedClass(Clazz viewedClass) {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        final int fragmentId = R.layout.fragment_class_instances;
        ...
        MenuItem.OnMenuItemClickListener onMenuItemClickListener = new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ClassInstancesFragment fragment = ClassInstancesFragment.this;
    ...
    public class InstancesAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final ClassInstance instance = instances.get(position);
